...
select public.create_werkbonsysteem_entity_table('van_vehicles');
select public.create_werkbonsysteem_entity_table('van_stock_items');
select public.create_werkbonsysteem_entity_table('van_stock_movements');
select public.create_werkbonsysteem_entity_table('van_stock_counts');
